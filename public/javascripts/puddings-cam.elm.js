		...
		return {
			...
			_0: A2(
				...
				A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$class('shape'),
						_1: {
							ctor: '::',
										...
										_1: {
											...
											_0: {
												...
												_1: A2(
													_elm_lang$core$Basics_ops['++'],
													_elm_lang$core$Basics$toString(
														scaleDown(dimension.widthPixel) - 4),
													'px')
											},
											_1: {
												ctor: '::',
												_0: {
													...
													_1: A2(
														_elm_lang$core$Basics_ops['++'],
														_elm_lang$core$Basics$toString(
															scaleDown(dimension.heightPixel) - 4),
														'px')
												},
												_1: {
													ctor: '::',
				...
				A2(
					...
					A2(
						...
						function (_p11) {
							...
							var _p17 = _p12._0;
							var _p16 = _p12._1;
							var dimension = _p16.size;
							var topLeft = _p16.location;
							return A2(
								_elm_lang$html$Html$div,
								{
									ctor: '::',
													...
													_1: {
														...
														_1: {
															...
															_1: {
																...
																_0: function () {
																	var cursor = function () {
																		var _p13 = mouseDragState;
																		if (_p13.ctor === 'Nothing') {
																			return 'default';
																		} else {
																			if (_p13._0.ctor === 'Resizing') {
																				return 'nwse-resize';
																			} else {
																				return 'grabbing';
																			}
				...
				function () {
					...
					return A2(
						...
						A2(
							...
							pathElems),
						function () {
							var _p18 = _elm_lang$core$List$head(pathReversed);
							if (_p18.ctor === 'Just') {
								return {
									ctor: '::',
				...
				_1: {
					...
					_1: {
						...
						_0: A2(
							...
							{ctor: '[]'},
							function () {
								var _p20 = model.workingAnnotation;
								if (_p20.ctor === 'Just') {
									var _p28 = _p20._0.shapes;
									var _p27 = _p20._0.mouseDragState;
									var _p26 = _p20._0.imageSize;
									return {
										ctor: '::',
										_0: A2(
											_elm_lang$html$Html$div,
												...
												}()),
											{
												...
												_1: function () {
													var _p25 = _p28;
													if (_p25.ctor === 'Just') {
														return A3(_user$project$Main$shapesView, _p20._0.scaleDown, _p27, _p25._0);
													} else {
														return {ctor: '[]'};
													}
												}()
												...
												{ctor: '[]'},
												{
													...
													_0: A2(
														_elm_lang$html$Html$button,
														{
															...
															_1: {
																ctor: '::',
																_0: _elm_lang$html$Html_Attributes$disabled(!_p20._0.modified),
																_1: {ctor: '[]'}
															}
														},
														{
													...
													{ctor: '[]'},
													{
														...
														_0: _elm_lang$html$Html$text(
															A2(
																...
																A2(
																	_elm_lang$core$Basics_ops['++'],
																	_elm_lang$core$Basics$toString(_p26.widthPixel),
																	A2(
																		_elm_lang$core$Basics_ops['++'],
																		'x',
																		_elm_lang$core$Basics$toString(_p26.heightPixel))))),
														_1: {ctor: '[]'}
													}),
												_1: {ctor: '[]'}
											}
...
var _user$project$Main$update = F2(
	function (msg, model) {
		...
		switch (_p30.ctor) {
			case 'NewLocation':
				var _p31 = A2(_elm_lang$core$String$split, '|', _p30._0.hash);
				_v15_3:
				do {
					if (_p31.ctor === '::') {
						if (_p31._1.ctor === '[]') {
										...
										return {
											...
											_1: A2(
												...
												A2(
													...
													A2(_elm_lang$core$Basics_ops['++'], '/files', _p31._1._0),
									...
									case '#annotate':
										var imagePath = A2(
											...
											A2(
												...
												function (_p32) {
													return !_elm_lang$core$String$isEmpty(_p32);
												},
												A2(_elm_lang$core$String$split, '/', _p31._1._0)));
										return {
											ctor: '_Tuple2',
			...
			case 'NewAnnotation':
				if (_p30._0.ctor === 'Ok') {
					var _p39 = _p30._0._0.annotations;
					return {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
							model,
										...
										return _elm_lang$core$Native_Utils.update(
											annotation,
											{
												shapes: function () {
													...
													_v16_3:
													do {
														if (((_p36.ctor === '_Tuple2') && (_p36._0.ctor === '::')) && (_p36._0._1.ctor === '[]')) {
															if (_p36._1.ctor === '[]') {
																return _elm_lang$core$Maybe$Just(
																	_user$project$Main$FaceOnly(_p36._0._0.shape));
															} else {
																if (_p36._1._1.ctor === '[]') {
																	var _p37 = _p36._0._0;
																	return _elm_lang$core$Maybe$Just(
																		A2(
																			...
																			_p37.shape,
																			A2(_user$project$Main$relativize, _p37.shape, _p36._1._0.shape)));
																} else {
																	if (_p36._1._1._1.ctor === '[]') {
																		var _p38 = _p36._0._0;
																		return _elm_lang$core$Maybe$Just(
																			A3(
																				_user$project$Main$FaceAndTwoEyes,
																				_p38.shape,
																				A2(_user$project$Main$relativize, _p38.shape, _p36._1._0.shape),
																				A2(_user$project$Main$relativize, _p38.shape, _p36._1._1._0.shape)));
																	} else {
																		break _v16_3;
																	}
																}
					...
					return {
						...
						_0: function () {
							var _p40 = _p41;
							if (_p40.ctor === 'BadStatus') {
								return _elm_lang$core$Native_Utils.eq(_p40._0.status.code, 404) ? model : _elm_lang$core$Native_Utils.update(
									model,
									{
										message: _elm_lang$core$Maybe$Just(
											_elm_lang$core$Result$Err(
												...
												scaleDown: function (_p42) {
													return _elm_lang$core$Basics$round(
														A2(
															...
															_elm_lang$core$Basics$toFloat(_user$project$Main$scaledWidthPx) / _elm_lang$core$Basics$toFloat(_p44.widthPixel),
															_elm_lang$core$Basics$toFloat(_p42)));
												},
												scaleUp: function (_p43) {
													return _elm_lang$core$Basics$round(
														A2(
															F2(
																function (x, y) {
															...
															_elm_lang$core$Basics$toFloat(_p44.widthPixel) / _elm_lang$core$Basics$toFloat(_user$project$Main$scaledWidthPx),
															_elm_lang$core$Basics$toFloat(_p43)));
												}
											});
									},
									model.workingAnnotation)
			...
			case 'DragToCreateBoxStart':
				var _p45 = A2(
					...
					model.workingAnnotation);
				if ((_p45.ctor === 'Just') && (_p45._0.ctor === 'FaceAndTwoEyes')) {
					return {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
							model,
							...
							model,
							{
								workingAnnotation: A2(
									...
									function (annotation) {
												...
												switch (_p48._0.ctor) {
													case 'FaceOnly':
														...
														return {
															ctor: '_Tuple3',
															_0: _elm_lang$core$Maybe$Just(
																A2(_user$project$Main$FaceAndOneEye, _p49, rect)),
													...
													case 'FaceAndOneEye':
														...
														return {
															ctor: '_Tuple3',
															_0: _elm_lang$core$Maybe$Just(
																A3(_user$project$Main$FaceAndTwoEyes, _p50, _p48._0._1, rect)),
										...
										var newShapes = _p47._0;
										var shapeId = _p47._1;
										var constrainTo = _p47._2;
														...
														do {
															if (_p52.ctor === '_Tuple2') {
																switch (_p52._0.ctor) {
																	...
																	case 'Eye2':
																		if (_p52._1.ctor === 'FaceAndTwoEyes') {
																			return _p52._1._0.size;
																		} else {
																			break _v21_3;
																		}
